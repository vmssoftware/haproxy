...
#ifdef __VMS
		else if (errno == EAGAIN || errno == EADDRINUSE || errno == EADDRNOTAVAIL || errno == EWOULDBLOCK) {
#else
		else if (errno == EAGAIN || errno == EADDRINUSE || errno == EADDRNOTAVAIL) {
#endif
			char *msg;
#ifdef __VMS
			if (errno == EAGAIN || errno == EADDRNOTAVAIL || errno == EWOULDBLOCK) {
#else
