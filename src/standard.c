...
char *ulltoa(unsigned long long n, char *dst, size_t size)
{
	...
	if (n >= 1ULL && n <= 9ULL) {
		i = 0;
      	...
      	else if (n >= 10ULL && n <= 99ULL) {
		i = 1;
	}
	else if (n >= 100ULL && n <= 999ULL) {
		i = 2;
	}
	else if (n >= 1000ULL && n <= 9999ULL) {
		i = 3;
	}
	else if (n >= 10000ULL && n <= 99999ULL) {
		i = 4;
	}
	else if (n >= 100000ULL && n <= 999999ULL) {
		i = 5;
	}
	else if (n >= 1000000ULL && n <= 9999999ULL) {
		i = 6;
	}
	else if (n >= 10000000ULL && n <= 99999999ULL) {
		i = 7;
	}
	else if (n >= 100000000ULL && n <= 999999999ULL) {
		i = 8;
	}
	else if (n >= 1000000000ULL && n <= 9999999999ULL) {
		i = 9;
	}
	else if (n >= 10000000000ULL && n <= 99999999999ULL) {
		i = 10;
	}
	else if (n >= 100000000000ULL && n <= 999999999999ULL) {
		i = 11;
	}
	else if (n >= 1000000000000ULL && n <= 9999999999999ULL) {
		i = 12;
	}
	else if (n >= 10000000000000ULL && n <= 99999999999999ULL) {
		i = 13;
	}
	else if (n >= 100000000000000ULL && n <= 999999999999999ULL) {
		i = 14;
	}
	else if (n >= 1000000000000000ULL && n <= 9999999999999999ULL) {
		i = 15;
	}
	else if (n >= 10000000000000000ULL && n <= 99999999999999999ULL) {
		i = 16;
	}
	else if (n >= 100000000000000000ULL && n <= 999999999999999999ULL) {
		i = 17;
	}
	else if (n >= 1000000000000000000ULL && n <= 9999999999999999999ULL) {
		i = 18;
     	}
	else if (n >= 10000000000000000000ULL && n <= ULLONG_MAX) {
		i = 19;
	}
#else
	switch(n) {
...
char *ultoa_o(unsigned long n, char *dst, size_t size)
{
	...
	else if (n >= 10U && n <= 99UL) {
		i = 1;
	}
	else if (n >= 100U && n <= 999UL) {
		i = 2;
	}
	else if (n >= 1000U && n <= 9999UL) {
		i = 3;
	}
	else if (n >= 10000U && n <= 99999UL) {
		i = 4;
	}
	else if (n >= 100000U && n <= 999999UL) {
		i = 5;
	}
	else if (n >= 1000000U && n <= 9999999UL) {
		i = 6;
	}
	else if (n >= 10000000U && n <= 99999999UL) {
		i = 7;
	}
	else if (n >= 100000000U && n <= 999999999UL) {
		i = 8;
	}
	else if (n >= 1000000000ULL && n <= ULONG_MAX) {
		i = 9;
	}
#else
	switch (n) {
...
char *utoa_pad(unsigned int n, char *dst, size_t size)
{
	...
	else if (n >= 1000U && n <= 9999U) {
		i = 3;
	}
	else if (n >= 10000U && n <= 99999U) {
		i = 4;
	}
	else if (n >= 100000U && n <= 999999U) {
		i = 5;
	}
	else if (n >= 1000000U && n <= 9999999U) {
		i = 6;
	}
	else if (n >= 10000000U && n <= 99999999U) {
		i = 7;
	}
	else if (n >= 100000000U && n <= 999999999U) {
		i = 8;
	}
     	else if (n >= 1000000000U && n <= 4294967295U) {
		i = 9;
	}
#else
	switch(n) {
