...
#ifdef __VMS
#define UBOUND(a, max)	{ __typeof__(a) b = (max); if ((a) > b) (a) = b; }
#else
...
#ifdef __VMS
#define LBOUND(a, min)	{ __typeof__(a) b = (min); if ((a) < b) (a) = b; }
#else
 ...
 */
#if (defined(__i386__) || defined(__x86_64__)) && !defined(__VMS)
