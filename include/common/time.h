...
{
#ifdef __VMS
	tv->tv_sec  = (__typeof__(tv->tv_sec))TV_ETERNITY;
	tv->tv_usec = (__typeof__(tv->tv_usec))TV_ETERNITY;
#else
 ...
 */
#ifdef __VMS
#define tv_iseternity(tv)       ((tv)->tv_usec == (__typeof__((tv)->tv_usec))TV_ETERNITY)
#else
 ...
 */
#ifdef __VMS
#define tv_isset(tv)       ((tv)->tv_usec != (__typeof__((tv)->tv_usec))TV_ETERNITY)
#else
